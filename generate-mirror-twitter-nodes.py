...
from helpers.cypher import create_dao_nodes, create_member_nodes, create_proposal_nodes, create_token_nodes, create_articles_nodes, create_account_nodes, create_wallet_nodes, create_article_wallet_relations, create_article_account_relations
...
if __name__ == "__main__":
    ...
    # create_account_nodes(conn)
    
    # create article nodes
    # create_articles_nodes(conn)
    
    # create wallet nodes
    # create_wallet_nodes(conn)

    # create article <> wallet relations
    create_article_wallet_relations(conn)

    # create article <> account relations
    create_article_account_relations(conn)
